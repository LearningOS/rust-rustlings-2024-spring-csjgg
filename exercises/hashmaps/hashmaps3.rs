...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        if scores.contains_key(&team_1_name){
            ...
            scores.insert(team_1_name.clone(), Team{goals_scored: team_1_score, goals_conceded: 0});
            scores.get_mut(&team_1_name).unwrap().goals_conceded += team_2_score;
        }
        if scores.contains_key(&team_2_name){
            ...
            scores.insert(team_2_name.clone(), Team{goals_scored: team_2_score, goals_conceded: 0});
            scores.get_mut(&team_2_name).unwrap().goals_conceded += team_1_score;
        }
    }
    scores
